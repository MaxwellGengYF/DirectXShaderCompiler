...
using my_uint8_t [[vk::ext_capability(/* Int8 */ 39)]] =
    vk::SpirvType</* OpTypeInt */ 21, 8, 8, vk::Literal<vk::integral_constant<uint, 8> >,
                  vk::Literal<vk::integral_constant<bool, false> > >;

[[vk::ext_instruction(/* OpConstant */ 43)]] my_uint8_t mkconsant([[vk::ext_literal]] int v);

// CHECK: OpConstant %spirvIntrinsicType 42
static const my_uint8_t K = mkconsant(42);
